  ...
  return (
    <div id={id}>
      <style>{`
        ...
        .hospital-name { font-size: 1.25rem; font-weight: 600; }
      ...
      <div className="report-container">
        <div className="report-header">
          ...
          <div className="hospital-info">
             <div className="hospital-name">{user?.hospitalName || 'General Hospital'}</div>
          </div>
        </div>
        ...
        <div className="section">
          ...
          <div className="summary-card">
            ...
            <div className="summary-item">
             ...
             <div className="summary-item">
              <span className="summary-label">Generated By:</span>
              <span className="summary-value">{user?.name || 'N/A'}</span>
            </div>
            <div className="summary-item">
        ...
        <div className="section">
         ...
         <div className="section">
          <h2 className="section-title">Patient Clinical History</h2>
          <div className="card">
             <p className="card-factors">{patientData?.patientHistory || 'No clinical history provided.'}</p>
          </div>
        </div>
