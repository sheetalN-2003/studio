    ...
    <AdminGuard>
        ...
        <div className="grid gap-6">
            ...
            <Card className="lg:col-span-2">
                ...
                <CardDescription>Monitor the daily and weekly prediction analysis volume for your hospital.</CardDescription>
                </CardHeader>
            ...
            <Card>
                ...
                <CardDescription>Most frequently predicted diseases across all analyses in your hospital.</CardDescription>
                </CardHeader>
                <CardContent className="h-[300px] w-full">
                <ResponsiveContainer width="100%" height="100%">
